Pod::Spec.new do |s|
  ...
  s.source    = {
    :http => 'https://github.com/siuying/VLCKit/releases/download/3.3.9-vlc-headers/MobileVLCKit-3.3.9.zip',
    :sha256 => 'ba8b324df9c610d5830a373b5dafca65ace90851f1713d1eadd2695f250019a4'
  }
